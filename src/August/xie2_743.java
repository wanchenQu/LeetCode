...
public class xie2_743 {

    static int N = 110, M = 6010, idx, INF = 0x3f3f3f3f, n, k;
    static int[] e = new int[M], ne = new int[M], he = new int[N], w = new int[M], shortest = new int[M];
    static boolean[] visited = new boolean[M];
    /**
     * int[nodeVal, shortest]
     */
    ...
    public static void dijkstra() {
        while (!q.isEmpty()) {
            ...
            for (int i = he[id]; i != -1; i = ne[i]) {
                int j = e[i];
                if (shortest[j] > shortest[id] + w[i]) {
                    shortest[j] = shortest[id] + w[i];
